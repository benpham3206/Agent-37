...
class Actor:
    def __init__(self, actions: Actions, model: OpenAICompatible, recorder: Recorder):
        self.actions, self.model, self.recorder = actions, model, recorder

    def step(self, goal: str):
        payload = self.actions.observe()
